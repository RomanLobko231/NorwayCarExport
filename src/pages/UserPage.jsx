  ...
  return (
    <>
      ...
      {!isLoading && !error && userData && (
        ...
        >
          <UserDataPanel user={userData} />

          <div
            className={`mt-5 ${userData.role == "BUYER" ? "max-w-7xl" : "max-w-5xl"} flex w-full flex-col items-center rounded-lg border border-light-gray bg-slate-50 p-4 md:p-6`}
          >
