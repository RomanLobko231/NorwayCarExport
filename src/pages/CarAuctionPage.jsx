        ...
        <div className="flex w-full max-w-7xl flex-col items-center justify-center px-4 py-20">
          ...
          <div className="flex w-full max-w-[700px] flex-col items-start">
            ...
            <div className="mt-7 flex w-full flex-row items-center justify-center space-x-4 md:mt-10">
              ...
              <h1 className="text-center text-2xl font-semibold text-medium-gray md:text-2xl">
                Auction Details
              </h1>
            ...
            <div className="mt-5 flex w-full flex-col items-center rounded-lg border border-dashed border-medium-gray bg-gradient-to-br from-swamp-100 to-lighthouse p-4">
              <div className="mt-2 flex w-full flex-col items-center gap-2 rounded-lg border border-gunmental bg-lighthouse p-4 md:flex-row md:justify-around">
              ...
              <p
                className={`mb-1 mt-6 w-auto cursor-pointer border-b-2 border-light-gray text-center text-xl font-medium text-light-gray hover:border-medium-gray hover:text-medium-gray`}
                onClick={() => {
            ...
            <div className="mt-5 flex w-full flex-col items-center rounded-lg border border-dashed border-medium-gray bg-gradient-to-br from-swamp-100 to-lighthouse p-4"></div>
          </div>
        </div>
      )}
    </>
