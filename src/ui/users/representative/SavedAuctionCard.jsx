...
const SavedAuctionCard = ({ auctionData }) => {
  ...
  return (
    <a
      className="card_shadow hover:card_shadow_hover active:card_shadow_click flex w-full flex-col gap-3 rounded-lg border border-swamp-500 bg-gradient-to-br from-swamp-100 to-distant-cloud p-3"
      href={`/auction/${auction.carDetails.carId}`}
    >
      <div className="flex w-full flex-col gap-3 lg:flex-row">
        <div className="aspect-square max-h-[120px] min-h-[120px] rounded border border-swamp-500 md:max-h-[120px]">
