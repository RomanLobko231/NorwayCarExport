      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-2">
        <DialogPanel className="mr-4 max-w-lg space-y-4 rounded-lg border bg-lighthouse p-6 md:p-8">
          ...
          <div className="flex gap-4">
            ...
            <button
              className="card_shadow text text-danger-red hover:bg-danger-red group mb-2 mt-5 flex flex-row items-center rounded-lg border border-medium-gray bg-lighthouse px-4 pb-1 pt-1 text-xl font-semibold hover:text-lighthouse"
              onClick={() => {
                onFunc();
                setIsOpen(false);
              }}
